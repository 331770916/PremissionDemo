package com.lib.weight.picktime.lib;
...
import com.lib.weight.picktime.adapter.WheelAdapter;
import com.lib.weight.picktime.listener.OnItemSelectedListener;
import com.lib.weight.picktime.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public void setTextColorCenter(int a_color1,int a_color2){
        this.textColorCenter = a_color1;
        textColorOut = a_color2;
        paintCenterText.setColor(textColorCenter);
        paintOuterText.setColor(textColorOut);
    }
